...
import org.ops5.push.engine.GATestCase;
import org.ops5.push.engine.Interpreter;
import org.ops5.push.engine.ObjectPair;
...
import org.ops5.push.engine.TestCase.TestCaseGenerator;


/**
 * This problem class implements symbolic regression for floating point numbers using co-evolved prediction. The class
 * must keep track of the amount of effort it takes compared to the effort of the co-evolving predictor population, and
 * use about 95% of the effort. Effort based on the number of evaluation executions thus far, which is tracked by the
 * interpreter.
 */
public class CEFloatSymbolicRegression extends PushGP
{
  ...
  private HashMap<String, String> GetPredictorParameters(HashMap<String, String> parameters)
      throws Exception
  {

    HashMap<String, String> predictorParameters = new HashMap<String, String>();

    predictorParameters.put("max-generations", Integer.toString(Integer.MAX_VALUE));
  ...
  /**
   * NOTE: This is entirely copied from PushGP, except EvaluateIndividual was changed to PredictIndividual, as noted
   * below.
   */

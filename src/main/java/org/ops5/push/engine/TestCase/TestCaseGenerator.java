...
package org.ops5.push.engine.TestCase;
 ...
 * <p/>
 * Each test case is a dictionary of HashMap< String, Object >. Each entry in the dictionary corresponds to a problem
 * input, except for the special token "output", which is reserved for the problem output.
 */

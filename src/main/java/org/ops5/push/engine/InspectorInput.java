...
/**
 * A utility class to help read PushInspector input files.
 */
...
public class InspectorInput
{
   ...
   */
  public InspectorInput(File inFile)
      throws Exception
  {
   ...
   * <p/>
   * 1 Program to execute 2 Execution limit 3 Integer, float, or boolean inputs 4 Available instructions. This is only
   * used for creating random code with code.rand or exec.rand
   *
   * @param inFile The file to input from.
   */
  private void InitInspectorInput(File inFile)
      throws Exception
  {

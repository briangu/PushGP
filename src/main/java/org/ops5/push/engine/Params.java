...
public class Params
{
  ...
  public static HashMap<String, String> Read(String inParams, HashMap<String, String> inMap, File inFile)
      throws Exception
  {
    int linenumber = 0;
    ...
    try
    {
      BufferedReader reader = new BufferedReader(new StringReader(inParams));
      String line;
      String parent;
      ...
      while ((line = reader.readLine()) != null)
      {
        ...
        if (line.startsWith("include"))
        {
          ...
          String includefile = line.substring(startIndex, line.length()).trim();
  ...
  static String ReadFileString(String inPath)
      throws Exception
  {
  ...
  public static String ReadFileString(File inFile)
      throws Exception
  {
